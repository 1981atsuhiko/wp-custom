...
<?php
	...
	$tagn = get_categories($args);
	$tagID = $tagn[0]->term_id;
	$newTagID = $tagID + 1;
	var_dump($newTagID);
?>
...
<label for="tag-slug"><?php echo $newTagID; ?></label>
	<input name="slug" id="tag-slug" type="text" value="<?php echo $newTagID ?>" size="40" />
